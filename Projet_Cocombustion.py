...
MASSE_SECH_HUMID = {}                                    # Index combustible_sech-humid, année
...
#Ajouté, wilfried
    for s in combustibles:
        MASSE_SECH_HUMID[s,i] = model.addVar(lb = 0, vtype = GRB.CONTINUOUS, ub = dispo_sech_humid[s], name=f'm{s}{i}')
